        ...
        child: Material(
          ...
          child: Container(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              // Λεωφορείο: ΙΣΟΤΙΜΗ 3η επιλογή, ίδιο single-select μενού.
              _subMenuItem(ctx: ctx, icon: Icons.directions_bus_rounded, label: 'Λεωφορείο',
                  selected: currentType == VehicleType.bus, activeColor: Colors.black,
                  onTap: () => Navigator.pop(ctx, VehicleType.bus)),
