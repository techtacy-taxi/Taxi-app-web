      ...
      child: Column(
        ...
        children: [
          ...
          const Text(
            ...
            '25 λεπτά πριν το ραντεβού αν η πτήση έχει καθυστέρηση — και '
            ...
            child: Column(
              ...
              children: const [
                ...
                Text(
                  ...
                  '3.  ⚠️ ΑΠΑΡΑΙΤΗΤΟ: πάνω δεξιά πάτα το μπλε κουμπί '
                  '«Subscribe to Test» και διάλεξε το πλάνο «Basic» '
                  '(\$0.00/μήνα). Δεν χρειάζεται πιστωτική κάρτα.\n\n'
                  '     ΧΩΡΙΣ αυτό το βήμα το κλειδί ΔΕΝ δουλεύει — '
                  'εμφανίζεται κανονικά στη σελίδα, αλλά κάθε κλήση '
                  'απορρίπτεται με σφάλμα «403 Forbidden» και δεν θα '
                  'έρχονται ενημερώσεις πτήσεων.\n\n'
                  '4.  Μόλις ολοκληρωθεί, το κουμπί αλλάζει από '
                  '«Subscribe to Test» σε «Run» — έτσι ξέρεις ότι η '
                  'συνδρομή είναι ενεργή.\n\n'
                  '5.  Στη σελίδα του API θα δεις ένα πεδίο με τίτλο '
                  '«X-RapidAPI-Key» και έναν μακρύ κωδικό δίπλα. Αυτό είναι '
                  'το κλειδί σου.\n\n'
                  '6.  Αντέγραψέ το και επικόλλησέ το στο πεδίο παρακάτω, '
                  'μετά πάτα «Αποθήκευση κλειδιού».\n\n'
                  'Το δωρεάν πλάνο δίνει 600 μονάδες τον μήνα — μία ανά '
                  'δουλειά με πτήση, δηλαδή αρκεί για εκατοντάδες '
                  'μεταφορές.',
