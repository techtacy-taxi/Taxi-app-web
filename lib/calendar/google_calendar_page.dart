            ...
            child: Container(
              ...
              child: TableCalendar<CalendarEvent>(
                ...
                calendarStyle: CalendarStyle(
                  ...
                  // ΚΡΙΣΙΜΟ: χωρίς αυτό, το table_calendar συνεχίζει να
                  // δεσμεύει χώρο και να σχεδιάζει ΤΗ ΔΙΚΗ ΤΟΥ προεπιλεγμένη
                  // (μαύρη) κουκκίδα ΑΠΟ ΚΑΤΩ από το δικό μας markerBuilder
                  // — φαίνεται σαν δεύτερη σειρά μαύρων κουκκίδων. Το
