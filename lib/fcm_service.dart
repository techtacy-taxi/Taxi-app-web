...
Future<void> _showPublicBookingBg(
  ...
  // publicBookingNotifId) ώστε ένα cancel να σβήνει και τα δύο. Πριν, το
  // background χρησιμοποιούσε ('booking'.hashCode ^ savedJobId.hashCode) —
  // διαφορετικό id, οπότε το ένα από τα δύο έμενε ζωντανό με FLAG_INSISTENT.
